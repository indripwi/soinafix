...
@section('content')
    ...
    <main class="main">
        ...
        <div class="container my-5">
            ...
            @php
                ...
                $pendaftaranBuka = Setting::getValue('pendaftaran_status') === 'buka';
            @endphp

            {{-- Tampilkan pesan jika ditutup --}}
            @if (!$pendaftaranBuka)
                <div class="alert alert-warning">
                    Maaf, pendaftaran saat ini sedang <strong>ditutup</strong>.
                </div>
            @endif

            {{-- Tampilkan form hanya jika pendaftaran dibuka --}}
            @if ($pendaftaranBuka)
                ...
                <form action="{{ route('pendaftaran.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="nama_pendaftar" value="{{ old('nama_pendaftar') }}"
                            required>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 justify-content-center">
                                                ...
                                                <form class="form-hapus" data-nama="{{ $item->nama_pendaftar }}"
                                                    action="{{ route('pendaftaran.hapus', ['slug' => $item->slug]) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
    ...
    <!-- Modal Login -->
    @guest
        <div class="modal fade" id="guestLoginModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static"
