                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        ...
                                        <form action="{{ route('pendaftaran.hapus', ['slug' => $item->slug]) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
                                            @csrf
                                            @method('DELETE')
...
>>>>>>> b4c2f3d8209fc902d1e5d9510a39c06044ce2aeb
                            @endforeach
                        </ul>
                    </div>
                @endif
