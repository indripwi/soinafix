            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6 order-2 order-lg-1 content" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <p class="fst-italic">
                            Special Olympics Indonesia (SOIna) adalah organisasi nirlaba yang diakui Pemerintah dan telah
                            mendapat akreditasi dari Special Olympics International (SOI) untuk menyelenggarakan pelatihan
                            dan kompetisi olahraga,
                            serta inisiatif/program non-olahraga lainnya bagi Penyandang Disabilitas Intelektual (Persons
                            with Intellectual Disabilities) atau Orang Bertalenta Khusus (OBK) di Indonesia.
                        </p>
                        <ul>

                        </ul>
                        <a href="{{ route('tentang') }}" class="read-more"><span>Read More</span><i
        ...
        <section id="courses" class="courses section">
            ...
            <div class="container">
                    ...
                    @foreach ($programs as $item)
                        <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                            <div class="course-item">
                                <img src="{{ asset('storage/foto/' . $item->gambar_url) }}" class="img-fluid"
                                    alt="">
                ...
                <div class="text-center mt-4">
                    <a href="{{ route('program') }}" class="btn rounded-pill text-white px-4 py-2 w-100"
